...
//   console.log(data?.data)
  ...
  const handleSubmit = async() => {
   ...
   try {
      await chat.mutateAsync({from: user._id, to: user.status === "User" ?  "664c99e8421f68f32ee5528c" : id.toString(), message})
...
{/* {
 data && data?.data.map(mes => {
   return(
      <div className="chat-message my-1" key={mes._id}>
      ...
      <div className="relative flex">
         ...
         <div className="absolute right-0 items-center inset-y-0 hidden sm:flex">
            ...
            */}
            ...
            <button onClick={handleSubmit} disabled={!message} type="button" className="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none">
